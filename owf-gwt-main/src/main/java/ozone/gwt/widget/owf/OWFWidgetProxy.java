...
//////// This state listener stuff just doesn't work, otherwise I would call this after calling private/native getWidgetProxy
...
//  }-*/;
  ...
  private native void nativeCall(String methodName, JsResultOrError jsResultOrError, JsArrayMixed args) /*-{
    ...
    // in a row, it can overwrite the previous callback. I couldn't work around it other than to always call 
    // getWidgetProxy()
    ...
    // I think it's still needed, but I'm not 100% sure.
    
    var widgetProxy = this;
// closed check does not work. See above.
